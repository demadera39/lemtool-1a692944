  ...
  return (
    <div className="flex h-screen w-screen bg-background text-foreground overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full relative">
        ...
        {/* Full-screen preview mode overlay (for non-logged-in users) */}
        {report?.isPreview && !user && report?.screenshot && (
          <div className="fixed inset-0 z-40 flex items-center justify-center">
            {/* Full-width scrolling background */}
            <div className="absolute inset-0 overflow-hidden">
              <div className="animate-gentle-scroll min-w-full blur-[2px] opacity-90">
                <img 
            ...
            <div className="absolute inset-0 bg-background/30" />
            {/* Unlock card */}
            <div className="relative z-10 bg-card rounded-2xl shadow-2xl p-8 max-w-md text-center border border-border">
